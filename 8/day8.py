...
def get_antinode_locations(
    locations: list[tuple[int, int]], grid_size: tuple[int, int]
) -> set[tuple[int, int]]:
...
antinode_locations_by_antenna = [
    get_antinode_locations(grid_locations[antenna], grid_size)
    for antenna in grid_locations.keys()
]
